    ...
    <div class="container">
        <div class="forms">
            <div class="form login">
                ...
                <form action="valided.php" method="post" >
                    <div class="input-field">
                        <input type="email" name="manager_email" placeholder="Enter your email" required>
                        <i class='bx bx-envelope icons '></i>
                    </div>
                    <div class="input-field">
                        <input type="password" name="manager_id" placeholder="Enter your id">
